...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='data/data48778', help='dataset_name')
    ...
    parser.add_argument('--iteration', type=int, default=80000, help='The number of training iterations')
    parser.add_argument('--batch_size', type=int, default=1, help='The size of batch size')
